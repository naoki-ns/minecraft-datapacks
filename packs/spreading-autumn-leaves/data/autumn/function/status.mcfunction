...
tellraw @s ["",{"text":"[normal]","color":"aqua","clickEvent":{"action":"run_command","command":"/function autumn:speed/normal"}},{"text":" "},{"text":"[fast]","color":"yellow","clickEvent":{"action":"run_command","command":"/function autumn:speed/fast"}},{"text":" "},{"text":"[turbo]","color":"red","clickEvent":{"action":"run_command","command":"/function autumn:speed/turbo"}}]
